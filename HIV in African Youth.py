...
# Import the CSV file
death_cause = pd.read_csv("https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/Annual%20Number%20of%20Deaths%20by%20Cause.csv")
...
# Read the CSV file
death_rates = pd.read_csv("https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/HIV%20Death%20Rates.csv")
...
# Read the CSV file
child_inf = pd.read_csv("https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/HIV%20Infections%20(Child).csv")
child_inf_rest = pd.read_csv("https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/HIV%20Infections%20(Child-Rest%20of%20the%20World).csv")

# Read the CSV file
adol_inf = pd.read_csv("https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/HIV%20Infections%20(Adolescents).csv")
adol_inf_rest = pd.read_csv("https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/HIV%20Infections%20(Adolescents-Rest%20of%20the%20World).csv")
...
# Read the CSV file
gender_HIV = pd.read_csv('https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/Gender%20Share%20of%20HIV.csv', dtype={'Year': int})
...
PMTCT = pd.read_csv('https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/PMTCT.csv', dtype={'Year': int})
...
prev_know = pd.read_csv('https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/HIV%20Prevention%20Awareness.csv')
...
cond_know = pd.read_csv('https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/Condom%20Use%202016.csv')
...
mom_child = pd.read_csv('https://github.com/Jad-Shahine/MSBA350E-Individual-Project/blob/main/Mother%20Child%20Transmission.csv')
